package com.martin.ads.ui.bubbleseekbar;
...
import static com.martin.ads.ui.bubbleseekbar.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK;
import static com.martin.ads.ui.bubbleseekbar.BubbleSeekBar.TextPosition.BOTTOM_SIDES;
import static com.martin.ads.ui.bubbleseekbar.BubbleSeekBar.TextPosition.SIDES;

import static com.martin.ads.ui.bubbleseekbar.BubbleUtils.dp2px;
import static com.martin.ads.ui.bubbleseekbar.BubbleUtils.sp2px;
/**
...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_track_color,
                ContextCompat.getColor(context, R.color.seekBarColorPrimary));
        mSecondTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_second_track_color,
                ContextCompat.getColor(context, R.color.seekBarColorAccent));
