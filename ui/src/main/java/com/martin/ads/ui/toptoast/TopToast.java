package com.martin.ads.ui.toptoast;
...
public class TopToast implements View.OnClickListener {
    ...
    public static void hide() {
        if (getLayout() != null) {
            getLayout().startAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.popup_fade_hide));
     ...
     * @return
     */
    public TopToast setTitle(String title) {
        mTitle = title;
        return this;
    }
     ...
     * @return
     */
    public TopToast setIcon(Drawable icon) {
        mIcon = DEFAULT_VALUE;
        mIconDrawable = icon;
        return this;
    }
     ...
     * @return
     */
    public TopToast setIcon(Drawable icon, boolean isCircular) {
        mIcon = DEFAULT_VALUE;
        mIconDrawable = icon;
        mIsCircular = isCircular;
        return this;
    ...
    public TopToast setIcon(Drawable icon, int tintColor) {
        mIcon = DEFAULT_VALUE;
        mIconDrawable = icon;
        if (getContext() != null) {
            try {
     ...
     * @return
     */
    public TopToast setIcon(Drawable icon, int tintColor, boolean isCircular) {
        mIcon = DEFAULT_VALUE;
        mIconDrawable = icon;
        mIsCircular = isCircular;
        if (getContext() != null) {
     ...
     */
    public TopToast setIconSize(int size) {
        mIconSize = size;
        return this;
    }
    ...
    private void sneakView() {
        ...
        if(Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP)
            statusBarHeight/=2;
        layout.setPadding(46, statusBarHeight, 46, 0);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
        ...
        layout.startAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.popup_fadein_show));
        if (mAutoHide) {
